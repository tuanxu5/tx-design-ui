...
(self.webpackChunktx_design_ui = self.webpackChunktx_design_ui || []).push([
  [1213],
  {
    ...
    "./src/stories/TxRate.stories.js": (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const __WEBPACK_DEFAULT_EXPORT__ = {
        ...
        component: __webpack_require__("./src/components/tx-rate/tx-rate.jsx").A,
        parameters: { layout: "centered" },
        tags: ["autodocs"],
      };
      var Basic = { args: { value: 3, count: 5 } },
        Large = { args: { value: 4, count: 5, size: "32px" } },
        HalfStar = { args: { value: 2.5, count: 5, allowHalf: !0 } };
      const __namedExportsOrder = ["Basic", "Large", "HalfStar"];
      (Basic.parameters = {
        ...Basic.parameters,
        docs: {
        ...
        (HalfStar.parameters = {
          ...HalfStar.parameters,
          docs: {
            ...HalfStar.parameters?.docs,
            source: {
              originalSource: "{\n  args: {\n    value: 2.5,\n    count: 5,\n    allowHalf: true\n  }\n}",
              ...HalfStar.parameters?.docs?.source,
            },
          },
        });
    },
