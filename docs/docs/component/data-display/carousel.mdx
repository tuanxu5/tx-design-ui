...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-data-display-txcarousel--basic"
      width="100%"
      height="350px"
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-data-display-txcarousel--autoplay"
      width="100%"
      height="350px"
      style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
    />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-data-display-txcarousel--with-counter"
      width="100%"
      height="350px"
      style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
    />
