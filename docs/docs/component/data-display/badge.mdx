...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-data-display-txbadge--basic"
      width="100%"
      height="120px"
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-data-display-txbadge--overflow-count"
      width="100%"
      height="120px"
      style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
    />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-data-display-txbadge--status"
      width="100%"
      height="150px"
      style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
    />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-data-display-txbadge--standalone"
      width="100%"
      height="150px"
      style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
    />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-data-display-txbadge--ribbon"
      width="100%"
      height="200px"
      style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
    />
