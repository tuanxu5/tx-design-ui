...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-feedback-txprogress--basic"
      width="100%"
      height="150px"
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <iframe
      src="https://storybook-tx-design.pages.dev/iframe.html?viewMode=story&id=tx-design-ui-feedback-txprogress--sizes"
      width="100%"
      height="200px"
      style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
    />
