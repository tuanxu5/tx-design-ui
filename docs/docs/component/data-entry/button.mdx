...
<TxButton prefix={<TxIconOutline.IconAdd />} label="Icon Prefix" />
<TxButton label={<TxIconOutline.IconAdd />} />
<TxButton suffix={<TxIconOutline.IconAdd />} label="Icon Suffix" />
```
...
<TxButton shape="circle" label={<TxIconOutline.IconAdd />} />
