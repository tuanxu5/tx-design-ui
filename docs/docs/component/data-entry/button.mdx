...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <div style={{padding: '20px', background: '#f5f5f5', borderRadius: '8px', marginTop: '16px'}}>
      <p style={{marginBottom: '12px', fontSize: '14px'}}>
        📺 <a href="http://localhost:6006/?path=/story/tx-design-ui-data-entry-txbutton--type" target="_blank" rel="noopener noreferrer">View interactive demo in Storybook →</a>
      </p>
      <iframe
        src="http://localhost:6006/iframe.html?viewMode=story&id=tx-design-ui-data-entry-txbutton--type"
        width="100%"
        height="180px"
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <div style={{padding: '20px', background: '#f5f5f5', borderRadius: '8px', marginTop: '16px'}}>
      <p style={{marginBottom: '12px', fontSize: '14px'}}>
        📺 <a href="http://localhost:6006/?path=/story/tx-design-ui-data-entry-txbutton--size" target="_blank" rel="noopener noreferrer">View interactive demo in Storybook →</a>
      </p>
      <iframe
        src="http://localhost:6006/iframe.html?viewMode=story&id=tx-design-ui-data-entry-txbutton--size"
        width="100%"
        height="180px"
        style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
      />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <div style={{padding: '20px', background: '#f5f5f5', borderRadius: '8px', marginTop: '16px'}}>
      <p style={{marginBottom: '12px', fontSize: '14px'}}>
        📺 <a href="http://localhost:6006/?path=/story/tx-design-ui-data-entry-txbutton--disabled" target="_blank" rel="noopener noreferrer">View interactive demo in Storybook →</a>
      </p>
      <iframe
        src="http://localhost:6006/iframe.html?viewMode=story&id=tx-design-ui-data-entry-txbutton--disabled"
        width="100%"
        height="180px"
        style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
      />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <div style={{padding: '20px', background: '#f5f5f5', borderRadius: '8px', marginTop: '16px'}}>
      <p style={{marginBottom: '12px', fontSize: '14px'}}>
        📺 <a href="http://localhost:6006/?path=/story/tx-design-ui-data-entry-txbutton--loading" target="_blank" rel="noopener noreferrer">View interactive demo in Storybook →</a>
      </p>
      <iframe
        src="http://localhost:6006/iframe.html?viewMode=story&id=tx-design-ui-data-entry-txbutton--loading"
        width="100%"
        height="180px"
        style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
      />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <div style={{padding: '20px', background: '#f5f5f5', borderRadius: '8px', marginTop: '16px'}}>
      <p style={{marginBottom: '12px', fontSize: '14px'}}>
        📺 <a href="http://localhost:6006/?path=/story/tx-design-ui-data-entry-txbutton--danger" target="_blank" rel="noopener noreferrer">View interactive demo in Storybook →</a>
      </p>
      <iframe
        src="http://localhost:6006/iframe.html?viewMode=story&id=tx-design-ui-data-entry-txbutton--danger"
        width="100%"
        height="180px"
        style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
      />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <div style={{padding: '20px', background: '#f5f5f5', borderRadius: '8px', marginTop: '16px'}}>
      <p style={{marginBottom: '12px', fontSize: '14px'}}>
        📺 <a href="http://localhost:6006/?path=/story/tx-design-ui-data-entry-txbutton--icon" target="_blank" rel="noopener noreferrer">View interactive demo in Storybook →</a>
      </p>
      <iframe
        src="http://localhost:6006/iframe.html?viewMode=story&id=tx-design-ui-data-entry-txbutton--icon"
        width="100%"
        height="180px"
        style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
      />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <div style={{padding: '20px', background: '#f5f5f5', borderRadius: '8px', marginTop: '16px'}}>
      <p style={{marginBottom: '12px', fontSize: '14px'}}>
        📺 <a href="http://localhost:6006/?path=/story/tx-design-ui-data-entry-txbutton--shape" target="_blank" rel="noopener noreferrer">View interactive demo in Storybook →</a>
      </p>
      <iframe
        src="http://localhost:6006/iframe.html?viewMode=story&id=tx-design-ui-data-entry-txbutton--shape"
        width="100%"
        height="180px"
        style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
      />
...
<Tabs>
  <TabItem value="preview" label="Preview" default>
    <div style={{padding: '20px', background: '#f5f5f5', borderRadius: '8px', marginTop: '16px'}}>
      <p style={{marginBottom: '12px', fontSize: '14px'}}>
        📺 <a href="http://localhost:6006/?path=/story/tx-design-ui-data-entry-txbutton--gradient-background" target="_blank" rel="noopener noreferrer">View interactive demo in Storybook →</a>
      </p>
      <iframe
        src="http://localhost:6006/iframe.html?viewMode=story&id=tx-design-ui-data-entry-txbutton--gradient-background"
        width="100%"
        height="180px"
        style={{border: '1px solid #ddd', borderRadius: '8px', background: 'white'}}
      />
